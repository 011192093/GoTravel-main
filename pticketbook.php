...
<section id="slideshow">
    ...
    <div class="form">
      ...
      <label for="triptype">Trip type</label>
        ...
        <input type="text" id="sdate" name="sdate" placeholder="DD-MM-YYYY" >

        <label for="rdate">Return Date</label>
        <input type="text" id="rdate" name="rdate" placeholder="DD-MM-YYYY/optional for oneway trip" >
        <br>
        <br>

        <button type="submit" id="b1">Search for the cheapest flight <br><i class="fa fa-search"></i></button>
