...
<html>
  <head>
    <title>book launch ticket</title>
    <<style>
     form{
       margin-top: 10px;
...
$sql1=  "SELECT * FROM plane WHERE ticket_type Like '$ttype' and class='$class' and fly_date='$sdate'  and base like '$where'  and '$person' <= available_st  and dest like '$destination' ";
...
if($query_run-> num_rows > 0){
       while($result=mysqli_fetch_array($query_run)){
           ...
           <input type="text" name="search" placeholder="name" value="<?php echo "Plane name: ".$result['name'] ?>" readonly>
           <input type="text" name="search" placeholder="seat" value="<?php echo "available seat: ".$result['available_st'] ?>" readonly>
           <input type="text" name="search" placeholder="base" value="<?php echo "Fly from: ".$result['base'] ?>" readonly>
           <input type="text" name="search" placeholder="destination" value="<?php echo "destination: " .$result['dest'] ?>" readonly>
           <input type="text" name="search" placeholder="journey date" value="<?php echo "Flying date : ".$result['fly_date'] ?>" readonly>
           <input type="text" name="search" placeholder="journey hour" value="<?php echo "Flight hour: ".$result['flight_hour'] ?>" readonly>
           <input type="text" name="search" placeholder="fare" value="<?php echo"fare: ". $result['fare'] ?>" readonly>
           <input type="text" name="search" placeholder="baggage" value="<?php echo"baggage: ". $result['Baggage'] ?>" readonly>
           <input type="text" name="search" placeholder="Ticket Type" value="<?php echo "Type: ".$result['ticket_type'] ?>" readonly>
           <input type="text" name="search" placeholder="Air cancel" value="<?php echo "Air cancellation fee: ".$result['Air_cancellation_fee'] ?>"readonly>
           <input type="text" name="search" placeholder="class" value="<?php echo "class:".$result['class'] ?>" readonly>
           
           <br>
           <button type="submit" id="b1" name="a" >BOOK Flight</button> 
        <br>
        <br>
        <br>
...
$sql3="INSERT INTO `plane_ticket`(`fromm`, `too`, `journey_date`, `return_date`, `passenger`, `class`, `trip_type`, `ticket_type`) VALUES ('$destination','$where','$rdate','0000-00-00','$person','$class','$triptype','$ttype')";  
$sql2=  "SELECT * FROM plane WHERE ticket_type Like '$ttype' and fly_date='$rdate' and class='$class' and base like '$destination'  and '$person' <= available_st  and dest like '$where' ";
