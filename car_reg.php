...
#b1{
  ...
  label{
    ...
    <section id="slideshow">
      <img id="slide" src="images/3.jpg" alt="Background Img">
      <div class="form">
        <form class=""  method="post" action="car_reg.php">
        ...
        <label >name</label>
          ...
          <input type="text" id="car_reg_number" name="car_reg_number"  >
          ...
          <label for="sdate">thana</label>
          <input type="text" id="thana" name="thana"  >
    
          <label for="rdate">House number</label>
          <input type="text" id="house" name="house"  >
          <br>
          <br>
          <button type="submit" id="b1" name="a" >Submit your response </button> 
...
if(isset($_POST['a'])) {
  ...
  $nid=$_POST['nid'];
  $email=$_POST['email'];
  $reg=$_POST['car_reg_number'];
  $license=$_POST['driving_license_no'];
  $city=$_POST['city'];
  $thana=$_POST['thana'];
  $house=$_POST['house'];
 ...
 $sql= "INSERT INTO `car`(`name`, `contact_number`, `nid_no`, `email`, `car_reg_number`, `driving_license_no`, `city`, `thana`, `house`) VALUES 
 (' $name','$number','$nid','$email',' $reg','$license','$city','$thana','$house')";
